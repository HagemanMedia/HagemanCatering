...
require_once HAGEMAN_CATERING_PLUGIN_DIR . 'includes/assets.php';
require_once HAGEMAN_CATERING_PLUGIN_DIR . 'includes/agenda/agenda.php';
require_once HAGEMAN_CATERING_PLUGIN_DIR . 'includes/maatwerk/form.php';
